<?php
	...
	class Painel
	{
		...
		//Converter a moeda para o front
		public static function convertMoney($valor){
			return number_format($valor, 2, ',','.');
		}

		//Converte a moeda para o banco de dados
		...
		public static function alert($tipo,$mensagem){
			if($tipo == 'sucesso'){
				echo '<div class="box-alert sucesso"><i data-feather="check"></i> '.$mensagem.'</div>';
			}else if($tipo == 'erro'){
				echo '<div class="box-alert erro"><i data-feather="info"></i> '.$mensagem.'</div>';
			}else if($tipo == 'atencao'){
				echo '<div class="box-alert atencao"><i data-feather="help-circle"></i>'.$mensagem.'</div>';
			}
		}
